    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api Ekuzika - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6289519009370">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>EkuzikaOfC</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"EkuzikaOfC" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Ekuzika`,
        html: inboxGmail,
      };
